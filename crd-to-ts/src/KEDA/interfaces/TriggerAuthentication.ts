...
import { TriggerAuthenticationSpec } from './TriggerAuthenticationSpec';
import { TriggerAuthenticationStatus } from './TriggerAuthenticationStatus';
...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   ...
   *
   * @required {false}
   * @originalType {TriggerAuthenticationMetadata}
   */
