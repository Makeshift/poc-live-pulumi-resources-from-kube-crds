...
import { ClusterTriggerAuthenticationSpecHashiCorpVaultCredential } from './ClusterTriggerAuthenticationSpecHashiCorpVaultCredential';
import { ClusterTriggerAuthenticationSpecHashiCorpVaultSecrets } from './ClusterTriggerAuthenticationSpecHashiCorpVaultSecrets';
...
export interface ClusterTriggerAuthenticationSpecHashiCorpVault {
   ...
   * @required {false}
   */
  credential?: ClusterTriggerAuthenticationSpecHashiCorpVaultCredential;
  /** mount
   *
   * @required {false}
   */
   ...
   * @required {true}
   */
  secrets: ClusterTriggerAuthenticationSpecHashiCorpVaultSecrets[];
}
